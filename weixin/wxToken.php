...
{
    //微信测试号的配置信息
    private static $appid='wxc5f9b7f4ece4cff0';//AppId
    private static $secret='c055146e7b1ba3aa7efb2a5961a289a5';//AppSecret

    //access_token 保存路径
    private static $token_path = '/tmp/wx_token.save';
